...
import easylevel from "./api/QuestionsEasy";
import mediumlevel from "./api/QuestionsMedium";
import interlevel from "./api/QuestionsInter";
import expertlevel from "./api/QuestionsExpert";
...
function App() {
  ...
  const axiosData = async () => {
    ...
    if (interIndex === 3 && expertIndex <= 1) {
      ...
      // expertlevel array
       randomIndex = Math.floor(Math.random() * expertlevel.length)
      setData(expertlevel[randomIndex])
    }
    if (mediumIndex === 5 && interIndex <= 3 && expertIndex === 0) {
      ...
      // interlevel array
       randomIndex = Math.floor(Math.random() * interlevel.length)
      setData(interlevel[randomIndex])
    }
    if (easyIndex === 7 && mediumIndex <= 5 && interIndex === 0) {
      ...
      // mediumlevel Array
       randomIndex = Math.floor(Math.random() * mediumlevel.length)
      setData(mediumlevel[randomIndex])
    }
    if (easyIndex <= 7 && mediumIndex === 0) {
      ...
      // easylevel Array!!
       randomIndex = Math.floor(Math.random() * easylevel.length)
      setData(easylevel[randomIndex])
